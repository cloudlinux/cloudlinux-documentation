...
* [CloudLinux OS Shared without EasyApache 4](/legacy/cloudlinux_installation/#cloudlinux-os-shared-without-easyapache-4)
...
1. Convert server from CentOS to CloudLinux OS Shared (see [these instructions](/legacy/cloudlinux_installation/#converting-existing-servers)).
