...
In case when a CloudLinux OS Shared user hits LVE limits, appropriate faults are generated and [lvestats](/legacy/deprecated/#lve-stats-0-x) package generates server processes snapshot. Snapshot is a list of running applications and a list of running MySQL queries right after the faults happened.
...
[Here](/legacy/control_panel_integration/) you will find the instructions and common techniques used to integrate your software with CloudLinux OS Shared.
