...
the cldeploy script converts CloudLinux OS Shared 7 to [CloudLinux OS Shared 7 Hybrid](/legacy/cloudlinux_os_kernel/#hybrid-kernels).
:::
...
* [Adding CloudLinux OS Shared image to DigitalOcean](/legacy/cloudlinux_installation/#adding-cloudlinux-os-shared-image-to-digitalocean)
...
* [CloudLinux OS Shared on Linode KVM](/legacy/cloudlinux_installation/#cloudlinux-os-shared-on-linode-kvm)
* [CloudLinux OS Shared on Linode Xen](/legacy/cloudlinux_installation/#cloudlinux-os-shared-on-linode-xen)
...
3. Convert to CloudLinux OS Shared using <span class="notranslate"> [deploy2cl](/legacy/cloudlinux_installation/#converting-existing-servers)</span> utility.
