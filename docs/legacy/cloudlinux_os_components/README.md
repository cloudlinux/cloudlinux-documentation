...
You can install Python Selector using the [CloudLinux OS Shared Installation Wizard](/legacy/lve_manager/#cloudlinux-os-shared-installation-wizard).
...
CloudLinux OS Shared offers JSON API for [lvectl](/legacy/command-line_tools/#lvectl) and [cloudlinux-limits](/legacy/command-line_tools/#cloudlinux-limits) via WHM. You can access it using the following URL:
...
* [CloudLinux OS Shared Python Selector](./#python-selector)
* [CloudLinux OS Shared Ruby Selector](./#ruby-selector)
* [CloudLinux OS Shared NodeJS Selector](./#node-js-selector)
...
* [How does it work with CloudLinux OS Shared?](./#how-does-it-work-with-cloudlinux-os-shared)
