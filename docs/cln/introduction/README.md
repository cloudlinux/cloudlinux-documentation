...
![CLN Server License Check: header with logo, red-outlined nav label, center card with magnifying glass on green checkmark, IP field, orange button.](/images/cln/introduction/serverlicensecheck_zoom70.webp)
