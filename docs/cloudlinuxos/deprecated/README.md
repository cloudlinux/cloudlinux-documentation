...
* [Python Selector (Old)](./#python-selector-old)
* [Git for cPanel](./#git-for-cpanel)
* [LVE-Stats 0.x](./#lve-stats-0-x)
* [OptimumCache](./#optimumcache)
* [TPE extension](./#tpe-extension)
* [CPU limits](./#cpu-limits)
* [Package integration](./#package-integration). You can use [Control panel integration guide](/cloudlinuxos/control_panel_integration/) instead.
...
:::tip Note
This documentation is for the old version of Python Selector. You can find documentation for the new Python Selector [here](/cloudlinuxos/cloudlinux_os_components/#python-selector)
:::
...
:::tip Note
LVE-STATS-0.X IS NO LONGER SUPPORTED, PLEASE USE [LVE-STATS 2](/cloudlinuxos/cloudlinux_os_components/#lve-stats-2)
:::
...
OptimumCache is going to index these directories. Thus system load during this period (from hours to days) might be as twice as high. See [Marking directories](./#marking-directories).
...
* [cloudlinux-collectl: quick start](./#cloudlinux-collectl-quick-start)
* [Install](./#install)
* [Measure web site response time](./#measure-web-site-response-time)
* [To watch what is being collected](./#to-watch-what-is-being-collected)
* [Statistics being collected in details](./#statistics-being-collected-in-details)
* [Statistics manual configuration](./#statistics-manual-configuration)
* [Running statistics daemon: collectl-cloudlinux](./#running-statistics-daemon-collectl-cloudlinux)
...
* [Installing for FS is different from Ext4](./#installing-for-fs-is-different-from-ext4)
* [Yum fails to install Perl rpms coming with OptimumCache](./#yum-fails-to-install-perl-rpms-coming-with-optimumcache)
* [OptimumCache prior 0.2-23: Cannot unmount old ploop image](./#optimumcache-prior-0-2-23-cannot-unmount-old-ploop-image)
* [High IO rate](./#high-io-rate)
* [High CPU utilization](./#high-cpu-utilization)
* [Uninstalling OptimumCache lasts for too long](./#uninstalling-optimumcache-lasts-for-too-long)
* [‘Failed to attach peer: Invalid argument’ appears in syslog](./#‘failed-to-attach-peer-invalid-argument’-appears-in-syslog)
...
This limit is no longer used, and <span class="notranslate"> [SPEED](/cloudlinuxos/limits/#speed-limits) </span> is used instead
:::
...
:::warning Note
You can use [Control panel integration guide](/cloudlinuxos/control_panel_integration/) instead.
:::
...
* [Advices and limitations](/cloudlinuxos/cloudlinux_installation/#advices-and-limitations)
* [CentOS with EasyApache 4](/cloudlinuxos/cloudlinux_installation/#centos-with-easyapache-4)
* [CentOS without EasyApache 4](/cloudlinuxos/cloudlinux_installation/#centos-without-easyapache-4)
* [CloudLinux OS without EasyApache 4](/cloudlinuxos/cloudlinux_installation/#cloudlinux-os-without-easyapache-4)
* [More about cloudlinux_ea3_to_ea4 script](/cloudlinuxos/cloudlinux_installation/#more-about-cloudlinux-ea3-to-ea4-script)
...
Follow the instructions [here](/cloudlinuxos/cloudlinux_os_components/#installation-3) to install and configure mod_lsapi.
...
1. Convert server from CentOS  to CloudLinux (see [these instructions](/cloudlinuxos/cloudlinux_installation/#converting-existing-servers)).
...
1. Convert server from CentOS to CloudLinux OS (see [these instructions](/cloudlinuxos/cloudlinux_installation/#converting-existing-servers)).
